...
INSERT INTO ACCOUNT(id, account_number, customer_id, balance, created_at, updated_at) values (1, '003544343', 1, 1000000, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO ACCOUNT(id, account_number, customer_id, balance, created_at, updated_at) values (2, '000453158', 2, 2000000, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
